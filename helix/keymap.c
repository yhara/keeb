...
CTL_T(KC_ESC), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                      KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_ENT, \
      KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,     KC_N,  KC_B,     KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_MINS , \
      ADJUST,  KC_ESC,  KC_LALT, KC_LGUI,LT(_LOWER,KC_LANG2),KC_SPC,KC_ENT,KC_BSPC,LT(_ADJUST,KC_SPC),LT(_RAISE,KC_LANG1),KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
      ),
  ...
  [_ADJUST] =  LAYOUT( \
      ...
      _______, RESET,   RGBRST,  KC_END,  _______, _______,                   _______, _______, _______, _______, M(0),    _______, \
