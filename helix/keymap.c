...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |Sh/Tab|   Z  |   X  |   C  |   V  |   B  |   N  |   B  |   N  |   M  |   ,  |   .  |   /  |  -   |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |Adjust| Esc  | Alt  | GUI  |EISU/Lo|Space| Enter| Bksp |Space |KANA/Ra| Left| Down |  Up  |Right |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = LAYOUT( \
...
SFT_T(KC_TAB)      KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,     KC_N,  KC_B,     KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_MINS , \
      ADJUST,  KC_LALT,  KC_LALT, KC_LGUI,LT(_LOWER,KC_LANG2),KC_SPC,KC_ENT,KC_BSPC,LT(_ADJUST,KC_SPC),LT(_RAISE,KC_LANG1),KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
      ),
   ...
   */
  [_LOWER] = LAYOUT( \
      KC_TILD, KC_EXLM, JP_AT,   KC_HASH, KC_DLR,  KC_PERC,                   JP_CIRC, JP_AMPR, JP_LPRN, JP_RPRN, JP_ASTR, KC_TRNS, \
      KC_TILD, KC_EXLM, JP_AT,   KC_HASH, KC_DLR,  KC_PERC,                   JP_CIRC, JP_AMPR, JP_LPRN, JP_RPRN, JP_ASTR, KC_TRNS, \
      _______,S(JP_CIRC),S(JP_YEN),JP_EQL,JP_YEN,  JP_GRV,                    JP_QUOT, JP_LCBR, JP_LBRC, JP_RBRC, JP_COLN, JP_RCBR, \
      _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_LPRN, KC_RPRN, JP_DQT,  JP_PLUS,S(KC_COMM),S(KC_DOT),S(KC_SLSH),JP_UNDS, \
      RESET  , _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY \
      ),
  ...
  [_RAISE] = LAYOUT( \
      ...
      JP_UNDS, KC_F7,   KC_F8,   KC_F9,   KC_F10,  JP_UNDS, _______, _______, _______,  JP_COLN, _______, _______, _______, _______, \
  ...
  [_ADJUST] =  LAYOUT( \
      ...
      _______, RESET,   RGBRST,  KC_END,  _______, _______,                   _______, _______, _______, _______, TMUX,    _______, \
      _______, KC_HOME, _______, KC_DEL,  KC_PGDN, _______,                   KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT,_______, _______, \
      _______, _______, _______, _______, _______, KC_PGUP, _______, _______, _______, _______, RGB_TOG, RGB_HUI, RGB_SAI, RGB_VAI, \
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
    ...
    case RGBRST:
      ...
      #endif
      break;
    case TMUX: // `^z[` (Start copy mode in my tmux)
      if (record->event.pressed) {
          SEND_STRING(SS_LCTRL("z")"[");
      }
      return false;
