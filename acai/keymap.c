...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0] = LAYOUT(
	       ...
	       LCTL_T(KC_A), LT(1,KC_S),LT(_PAREN,KC_D),LT(2,KC_F),    KC_G,               KC_H,          KC_J,       KC_K,       LT(1,KC_L),     RCTL_T(KC_SCLN),
	...
	[2] = LAYOUT(
		...
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_0,  KC_TRNS, KC_TRNS, KC_TRNS, KC_DOT, KC_SLSH
	),

	[3] = LAYOUT(
	       KC_ESC,       KC_TAB ,       KC_END,        _______,    KC_NO  ,        KC_NO,         _______,    KC_LNG2,     KC_LNG1,      KC_BSPC,
	       KC_HOME,      S(KC_TAB),     KC_DEL,        KC_NO  ,    _______,        KC_LEFT,       KC_DOWN,    KC_UP,       KC_RGHT,      KC_ENT,
	       KC_NO,        KC_NO    ,     KC_NO  ,       S(KC_INS),  KC_NO  ,        KC_NO  ,       KC_ENT ,    KC_PGUP,       KC_PGDN,        KC_NO,
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
	),

	[_CHGAPP] = LAYOUT(
		NXTAPP , KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_F12 , KC_F7  , KC_F8  , KC_F9  , KC_NO  ,  //KC_Fx does not work. Why?
		PRVAPP , KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_F11 , KC_F4  , KC_F5  , KC_F6  , KC_NO  ,
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_F10 , KC_F1  , KC_F2  , KC_F3  , KC_NO  ,
	...
	[_PAREN] = LAYOUT(
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_NO,   JP_LPRN, JP_RPRN, KC_NO,
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, JP_LCBR, JP_LBRC, JP_RBRC, JP_RCBR,
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_NO,   JP_LABK, JP_RABK, KC_NO,
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
	),
};
