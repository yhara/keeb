...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT_ortho_4x12(
    ...
    CTL_T(KC_ESC),KC_A,    KC_S,    KC_D,    KC_F ,  KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, LT(_MEDIA,KC_ENT), \
      ...
      KC_BSPC,KC_DEL,KC_LALT,KC_LGUI,LT(_LOWER,KC_LNG2),ALT_T(KC_SPC), KC_LEFT, LT(_CURSOR,KC_SPC),LT(_RAISE,KC_LNG1),KC_DOWN,KC_UP,KC_RGHT
      ),
  ...
  [_RAISE] = LAYOUT_ortho_4x12(
      ...
      _______, _______, _______, _______, _______, _______, _______, _______, KC_NO,   KC_NO,   KC_NO,     RESET 
      ),
