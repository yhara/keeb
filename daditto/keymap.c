...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
      ...
      CTL_T(KC_ESC),   KC_A,    KC_S,    KC_D,    KC_F ,   KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_ENT,            TG(_TGM),
      LSFT_T(KC_TAB),   KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_MINS,          KC_NO,
      KC_BSPC,KC_DEL,KC_LGUI,LT(_LOWER,KC_LNG2),LT(_CURSOR,KC_SPC),LT(_RAISE,KC_LNG1),        KC_LEFT,KC_DOWN,KC_UP,KC_RGHT
    ), 
  [_LOWER] = LAYOUT(
                                                                                                                    CK_DOWN, CK_UP,
  ...
  [_CURSOR] = LAYOUT(
                                                                                                                    KC_3, KC_4,
      KC_NO  ,KC_ESC ,KC_TAB  ,    KC_END, KC_NO  , KC_NO  ,  KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_BSPC  , KC_BSPC,          KC_NO,
      KC_NO  ,KC_HOME,S(KC_TAB),   KC_DEL, KC_PGDN, KC_NO  ,  KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT,KC_NO  , KC_NO,            KC_NO,
      KC_NO,S(C(KC_TAB)),C(KC_TAB),KC_NO  ,KC_NO  , KC_PGUP,  KC_NO,   KC_ENT  , KC_NO  , KC_NO   , KC_NO  , KC_NO  ,         KC_NO,
      _______, _______, _______,   _______,  _______,     _______,    _______, _______, _______,
      ),
  [_TGM] = LAYOUT(
                                                                                                                    KC_3, KC_4,
      KC_TAB,         KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSPC,            KC_NO,
      CTL_T(KC_ESC),   KC_A,    KC_S,    KC_D,    KC_F ,   KC_G,    KC_H,    KC_LEFT,KC_DOWN,KC_RIGHT,    KC_SCLN, KC_ENT,     _______,
      LSFT_T(KC_TAB),   KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_MINS,          KC_NO,
      _______, _______, _______,   _______,  KC_SPC,     KC_SPC,    KC_SPC,_______, _______, 
      ),
};
